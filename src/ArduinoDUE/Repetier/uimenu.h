...
*/
 ...
 #if HAVE_HEATED_BED==true
   #if NUM_EXTRUDER == 1
   UI_PAGE4(ui_page1,"\005%ec/%Ec\002\007%eB/%Eb\002","Z:%x2","Mul:%om Buf:%oB","%os");
   //UI_PAGE4(ui_page1,UI_TEXT_PAGE_EXTRUDER,UI_TEXT_PAGE_BED,UI_TEXT_PAGE_BUFFER,"%os");
   #else
   UI_PAGE4(ui_page1,"\005%e0/%E0\005%e1/%E1","\007%eB/%EbMul:%om%%%","Z:%x2","%os");
   #endif
 #else
...
// **** Extruder menu
#if NUM_EXTRUDER == 1
	UI_MENU_ACTIONCOMMAND(ui_menu_ext_load0,UI_TEXT_LOAD_FILAMENT,UI_ACTION_LOAD_EXTRUDER_0);
	UI_MENU_ACTIONCOMMAND(ui_menu_ext_unload0,UI_TEXT_UNLOAD_FILAMENT,UI_ACTION_UNLOAD_EXTRUDER_0);
	#define LOADCNT 2
	#define UIMENULOAD &ui_menu_ext_load0,&ui_menu_ext_unload0,
	#define UI_PAGE_HEATEXTRUDER "","\005%ec/%Ec\002","","%os"
#else
	UI_MENU_ACTIONCOMMAND(ui_menu_ext_load0,UI_TEXT_LOAD_LEFT_FILAMENT,UI_ACTION_LOAD_EXTRUDER_0);
	UI_MENU_ACTIONCOMMAND(ui_menu_ext_unload0,UI_TEXT_UNLOAD_LEFT_FILAMENT,UI_ACTION_UNLOAD_EXTRUDER_0);
	UI_MENU_ACTIONCOMMAND(ui_menu_ext_load1,UI_TEXT_LOAD_RIGHT_FILAMENT,UI_ACTION_LOAD_EXTRUDER_1);
	UI_MENU_ACTIONCOMMAND(ui_menu_ext_unload1,UI_TEXT_UNLOAD_RIGHT_FILAMENT,UI_ACTION_UNLOAD_EXTRUDER_1);
	#define LOADCNT 4
...
UI_MENU_ACTION4C(ui_menu_heatextruder_page,UI_ACTION_DUMMY,UI_PAGE_HEATEXTRUDER);
