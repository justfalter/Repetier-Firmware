...
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_6"Ajust the front","knob(s) so paper","just slides amid","nozzle and plate"
#define UI_TEXT_MANUAL_BED_LEVEL_PAGE_7 "Ajust the back","knob(s) so paper","just slides amid","nozzle and plate"
